...
module.exports = {
  ...
  caption: process.env.CAPTION || "`CASEYRHODES-V2™`",
  author: process.env.PACK_AUTHER || "CASEYRHODES-V2",
  packname: process.env.PACK_NAME || "CASEYRHODES",
  botname: process.env.BOT_NAME || "CASEYRHODES-V2",
  ...
  LANG: (process.env.THEME || "CASEYRHODES").toUpperCase(),
};
global.rank = "updated";
